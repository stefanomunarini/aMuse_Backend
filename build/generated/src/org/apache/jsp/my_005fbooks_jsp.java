...
public final class my_005fbooks_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("email")!=null){out.println("<a href=\"logout.jsp\"><span>Logout</span></a>");}
      ...
      out.write("        ");
            ...
            ArrayList<Book> lb = DBconnection.SearchMyBooks(email);

            if(lb==null) { out.println("Nessun book registrato"); }  
            else {
                for(Book b : lb){ 
                    out.println("<a href=\"book.jsp?IDEH="+ b.getIDexhibition() + "\">");
                    out.println("<div class=\"book_wrapper\"><div class=\"book_select\"></div>");
                    out.println("<div class=\"book_cover\" style=\"background-image: url(temp_exhibition/1.jpg)\"></div>"); 
                    out.println("<h3 class=\"book_title\">" + b.getTitle() + "</h3>");
                    out.println("<p class=\"book_description\">" + b.getDescription() + "</p>");
                 }
            }
