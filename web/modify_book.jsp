...
<html>
        ...
        <div id="modify_popup">
                <div id="modify_box">
                    ...
                    <div id="modify_box_up">
                      <p class="popup_email_text">Inserisci il titolo</p>
                      <% out.println("<textarea class=\"title_book\" name=\"title\" maxlength=\"25\">"+bk.getTitle()+"</textarea>"); %>
                      <p class="popup_email_text">Inserisci la descrizione</p>
                      ...
                      <input type="text" style="visibility:hidden; position:absolute;"  name="len" value="ita">  
                   </div>
                   <div id="modify_box_down">
                    <input type="submit" class="button_update" name="update" value="SALVA">
                   </div>
                 </form>
         ...
         <div id="cover_popup">      
            <div id="cover_box">
                ...
                <form name="uploadForm" action="upload_cover"  enctype="multipart/form-data" method="post">
                    <div id="cover_box_up">
                        <p class="popup_email_text">Cambia immagine di copertina</p>
                    ...
                    <div id="cover_box_down">
                        <input type="submit" class="button_update" name="update" value="CAMBIA COVER">
                    </div>
                </form>
            </div>
          </div>
        ...
        <div id="comment_popup">
            <div id="comment_box">
                ...
                <div id="comment_box_up">                       
                  <p class="popup_email_text">Inserisci il tuo commento all'opera<br/>
               ...
               <div id="comment_box_down">
                <input type="submit" class="button_update" name="comment_button" value="AGGIUNGI">
               </div>
             </form>
         ...
         <div id="photo_popup">      
            <div id="photo_box">
                ...
                <form name="uploadForm" action="upload_photo"  enctype="multipart/form-data" method="post">
                    <div id="photo_box_up">
                        <p class="popup_email_text">Aggiungi una o due tue foto all'opera <br/>
                        ...
                        <div style="float:left; width: 210px; margin-left: 40px;">
                           ...
                           <% out.println("<a href=\"delete_photo.jsp?idw="+id_work+"&idb="+id_book+"&name="+w.getURLworkIMG1()+"&v=1\"> ELIMINA FOTO</a>"); %>
                        </div>
                        <div style="float:right; width: 210px; margin-right: 40px;">
                            ...
                            <br/><div class="choose"><input type="file" name="file"></div>
                            <% out.println("<a href=\"delete_photo.jsp?idw="+id_work+"&idb="+id_book+"&name="+w.getURLworkIMG1()+"&v=2\"> ELIMINA FOTO</a>"); %>
                        </div>    
                    </div>
                    <div id="photo_box_down">
                        <input type="submit" class="button_update" name="photo" value="AGGIUNGI">
                    </div>
                </form>
            </div>
          </div>
        ...
        <div id="red_line">
            <div id="red_line_wrapper">
              ...
              <div class="guide_shadow">
                ...
                <a id="go_back" href="my_book.jsp">TORNA AI TUOI BOOK</a>
                <a href="my_book.jsp"><img style="float:right; margin-top: 7px;" src="images/back.jpg"></a>
            </div>
        </div>
    ...
    <div id="top_wrapper">
      ...
      <%
      out.println("<a href=\"book.jsp?&idb="+AmuseGuest.encripted(Integer.toString(id_book))+"&l=ita\">");
      ...
      out.println("<span class=\"special_button\">VISUALIZZA</span>");
      out.println("</div>");
      out.println("</a>");
%>
      ...
      <div class="guide" >
          ...
          <span class="special_button">RINOMINA</span>
      </div>
      </a>
          ...
          <div id="content_wrapper"> 
            ...
            <% 
                for(int i=0;i<bk.getMyWorks().size();i++ ){
                    ...
                    out.println("<a class=\"add_photo\" href=\"modify_book.jsp?id_book="+id_book+"&id_work="+wb.getIDWork()+"&add=photo\" ><div style=\"background-color: #999999; height:36px; width: 133px;float:left; \"><img src=\"images/add.jpg\" style=\"float:left;\"><p class=\"add\"> Foto</p> </div></a>");
                    out.println("<a class=\"add_comment\" href=\"modify_book.jsp?id_book="+id_book+"&id_work="+wb.getIDWork()+"&add=comm\"><div style=\"background-color: #999999; float:right;height:36px; width: 133px;\"><img src=\"images/add.jpg\" style=\"float:left;\"><p class=\"add\"> Commento</p> <p class=\"object_id\" title=\""+wb.getIDWork()+"\"></p> </div></a> </div>");
