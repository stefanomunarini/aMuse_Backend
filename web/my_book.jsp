  ...
  <body>
    <div id="red_line">
      <div id="red_line_wrapper">
          <a href="my_book_eng.jsp"><img src="images/flag_eng.jpg" style="width: 25px; height: 15px; float: right; margin-top: 5px; margin-left: 10px;">
          </a> 
    ...
    %>
    <div id="top_wrapper">
      <div id="title_area"><p id="title">I MIEI BOOK</p></div>
      <div id="logo_area">
    ...
    <div id="content_wrapper">
        <%
            for(Book b: alb){
                  ...
                  out.println ("<a href=\"book.jsp?idb=" + AmuseGuest.encripted(Integer.toString(b.getIDBook())) + "&l=ita\"><div class=\"view_button\">VISUALIZZA</div></a>");                  
                  out.println ("<a href=\"modify_book.jsp?id_book=" + b.getIDBook() + "\"><div class=\"modify_button\">MODIFICA</div></a>");
                  out.println ("</div>");
