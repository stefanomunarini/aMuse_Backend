 ...
 * @author Fede
 */
@WebServlet(urlPatterns = {"/upload_img_ex"})
public class upload_img_ex extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet upload_img_ex</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet upload_img_ex at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
...
if (item.getSize() > 0) {
    ...
    item.write(uploadedFile2);
        DBconnection.EditImgExhibition(Integer.parseInt(id_ex),fileName);    
